...
<body>
    ...
    <section class="home-section">
        <div class="dashboard-container">
            <div class="text bx bx-home">&nbsp;Home <div class='bx bx-chevron-right'></div> Dashboard <div class='bx bx-chevron-right'></div> Approve</div>
        </div>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <?php if (!$anyVisibleBookings): ?>
                            <tr>
                                <td colspan="8" class="text-center">No Approve</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
